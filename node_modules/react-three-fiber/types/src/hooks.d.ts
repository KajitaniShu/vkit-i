...
export declare function useRender(callback: RenderCallback, takeOverRenderloop?: boolean, deps?: any[]): void
...
export declare function useLoader<T>(Proto: THREE.Loader, url: string, extensions?: Extensions): [T, any[]]
export {}
